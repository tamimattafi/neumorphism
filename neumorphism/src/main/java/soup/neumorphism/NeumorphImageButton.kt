...
class NeumorphImageButton @JvmOverloads constructor(
    ...
    private val defStyleAttr: Int = R.attr.neumorphImageButtonStyle,
    private val defStyleRes: Int = R.style.Widget_Neumorph_ImageButton
    ...
    init {
        ...
        backgroundDrawable = a.getDrawable(R.styleable.NeumorphImageButton_neumorph_backgroundDrawable)
        ...
        inset = a.getDimensionPixelSize(R.styleable.NeumorphImageButton_neumorph_inset, 0)
        insetStart = a.getDimensionPixelSize(R.styleable.NeumorphImageButton_neumorph_insetStart, -1)
        insetEnd = a.getDimensionPixelSize(R.styleable.NeumorphImageButton_neumorph_insetEnd, -1)
        insetTop = a.getDimensionPixelSize(R.styleable.NeumorphImageButton_neumorph_insetTop, -1)
        insetBottom = a.getDimensionPixelSize(R.styleable.NeumorphImageButton_neumorph_insetBottom, -1)
        shadowElevation = a.getDimension(R.styleable.NeumorphImageButton_neumorph_shadowElevation, 0f)
        shadowColorLight = NeumorphResources.getColor(context, a, R.styleable.NeumorphImageButton_neumorph_shadowColorLight, R.color.design_default_color_shadow_light)
        shadowColorDark = NeumorphResources.getColor(context, a, R.styleable.NeumorphImageButton_neumorph_shadowColorDark, R.color.design_default_color_shadow_dark)
        a.recycle()
    }
